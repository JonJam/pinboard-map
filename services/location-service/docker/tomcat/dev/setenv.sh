...
CATALINA_OPTS="$CATALINA_OPTS -Dcom.sun.management.jmxremote.port=7031"
CATALINA_OPTS="$CATALINA_OPTS -Dcom.sun.management.jmxremote.ssl=false"
CATALINA_OPTS="$CATALINA_OPTS -Dcom.sun.management.jmxremote.authenticate=false"

# Enabling Java Remote Debug (https://wiki.apache.org/tomcat/FAQ/Developing#Q1)
CATALINA_OPTS="$CATALINA_OPTS -Xdebug -Xrunjdwp:transport=dt_socket,address=*:4031,server=y,suspend=n"